  ...
  <div class="flex flex-no-wrap bg-gray-200">
    ...
    >
      <div class="flex w-full">
        <div class="flex flex-col justify-center w-full">
          ...
          <ul aria-orientation="vertical" class="py-8 mt-4 rounded">
            <li
              class="py-1 text-sm leading-3 tracking-normal text-indigo-700 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
            >
            ...
            <li
              class="flex items-center py-1 mt-6 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
            >
        ...
        <div
          class="flex flex-col justify-start w-3/4 pr-12 transition duration-150 ease-in-out"
          id="mobile-nav"
        >
          <div class="mt-2">
            <svg
          ...
          <ul aria-orientation="vertical" class="py-8 rounded">
            <li
              class="py-2 text-sm leading-3 tracking-normal text-indigo-700 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
            >
              <span class="ml-2">Timeline</span>
            </li>
            <li
              class="flex items-center py-2 mt-6 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
            >
    ...
    <div class="w-full">
      ...
      >
        <div class="hidden w-full pr-6 lg:flex">
          <div class="items-center hidden w-1/2 h-full pl-6 pr-24 lg:flex">
            <div class="relative w-full">
              ...
              <input
                class="w-full py-2 pl-12 text-sm text-gray-500 bg-gray-100 border border-gray-100 rounded focus:outline-none focus:border-indigo-700"
                type="text"
                placeholder="Search"
              />
            </div>
          ...
          <div class="hidden w-1/2 lg:flex">
            <div class="flex items-center justify-end w-full pl-8">
              <div
                class="flex items-center justify-center w-20 h-full border-l border-r"
              >
                <div class="relative text-gray-600 cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          class="relative visible mr-8 text-gray-600 lg:hidden"
          @click="dropdownHandler"
        >
          <ul
            class="absolute right-0 hidden w-40 p-2 mt-12 bg-white border-r rounded shadow"
          >
            <li
              class="flex items-center justify-between w-full text-gray-600 cursor-pointer hover:text-indigo-700"
            >
          ...
          <svg
            ...
            aria-haspopup="true"
            xmlns="http://www.w3.org/2000/svg"
            class="cursor-pointer icon icon-tabler icon-tabler-menu"
            width="30"
            height="30"
            viewBox="0 0 24 24"
            stroke-width="1.5"
...
export default defineComponent({
  ...
  setup() {
    ...
    const sidebarHandler = () => {
      console.log("sidebar burger clicked");
    };

    return { dropdownHandler, sidebarHandler };
  },
});
</script>
